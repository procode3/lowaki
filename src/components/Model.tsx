...
export default function Model() {
	return (
		<div className="text-black bg-white w-full flex flex-col  gap-10 p-5 md:p-10 lg:px-20">
			...
			<div className="flex flex-col lg:flex-row justify-evenly gap-5 md:gap-10">
				<div className="w-full lg:w-2/3 relative flex flex-col gap-1 rounded-lg">
					<p className="text-[24px] md:text-[40px] font-medium text-black bg-white bg-opacity-10">
					...
					<div className="w-fill rounded-lg overflow-hidden opacity-70 h-[10vh] md:h-[30vh]">
						<Image
							src="/dotbg.svg"
							fill
				...
				<div className=" w-full lg:w-1/3 text-[18px] flex flex-col gap-3 md:gap-5 rounded-lg">
					<p className="text-[14px]  md:text-[18px] font-medium  text-neutral-800">
			...
			<div className="flex flex-col text-xl mt-5 md:mt-10 gap-5">
				<h3 className="text-lg md:text-xl font-medium">
					Our last mile entrepreneurs (LMEs) are able to access the hub to ;
				</h3>
				<div className="flex flex-col lg:flex-row gap-5">
					<div className="bg-gray-100 p-5  gap-1 md:gap-3  flex flex-col rounded-lg">
						<h4 className="text-lg md:text-xl capitalize ">Learn </h4>
						<p className="text-[14px] md:text-[18px] text-balance font-medium leading-[20px] md:leading-[28px]">
							...
							we&apos;re dedicated to providing women with the knowledge they
							need to thrive.
						</p>
					</div>
					<div className="bg-orange-100 p-5  gap-1 md:gap-3  flex flex-col rounded-lg">
						<h4 className="text-lg md:text-xl capitalize ">Access </h4>
						<p className="text-[14px] md:text-[18px] text-balance font-medium leading-[20px] md:leading-[28px]">
					...
					<div className="bg-green-100 p-5  gap-1 md:gap-3  flex flex-col rounded-lg">
						<h4 className="text-lg md:text-xl capitalize ">Earn </h4>
						<p className="text-[14px] md:text-[18px] text-balance font-medium leading-[20px] md:leading-[28px]">
