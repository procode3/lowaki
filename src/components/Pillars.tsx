...
export default function Pillars() {
	return (
		<div className="text-neutral-900 bg-white flex flex-col w-full h-full items-center justify-center gap-5 p-5 md:p-10 lg:p-20">
			...
			<div className="flex flex-col-reverse sm:flex-row-reverse lg:flex-row items-center gap-7">
				<div className="flex flex-col text-[14px] md:text-[18px]  w-full lg:w-1/2 ">
					<p>
				...
				<div className="w-full h-full items-center justify-center lg:w-1/2 relative py-5">
					...
					>
						<AccordionItem value="item-1">
							<AccordionTrigger className="p-3 mt-4 text-[14px] md:text-[18px]">
								Economic Development
							</AccordionTrigger>
							<AccordionContent className="text-neutral-700 text-[14px] md:text-[18px] p-3   transition">
						...
						<AccordionItem value="item-2">
							<AccordionTrigger className="p-3 text-[14px] md:text-[18px] mt-4 ">
								Climate Action
							</AccordionTrigger>
							<AccordionContent className="text-neutral-700 text-[14px] md:text-[18px]  p-3 ">
